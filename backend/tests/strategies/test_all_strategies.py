...
These run each of the 24 strategies through the same scenarios so a newly
...
def test_registry_has_all_twenty():
    # 21 original + 3 new high-win-rate strategies = 24 total
    assert len(STRATEGY_ITEMS) == 24
