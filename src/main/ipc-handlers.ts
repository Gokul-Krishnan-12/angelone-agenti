...
export function setupIpcHandlers() {
  ...
  ipcMain.handle(channels.AUTH_LOGIN, async (_, creds: any) => {
    console.log('[IPC] Received AUTH_LOGIN request');
    try {
      const result = await authManager.startLogin(creds);
  ...
  ipcMain.handle(channels.ORDERS_GET_ALL, async (_, params?: any) => {
    return await pythonBridge.call('get_orders', params);
  });
  ...
  ipcMain.handle(channels.PORTFOLIO_POSITIONS, async (_, params?: any) => {
    return await pythonBridge.call('get_positions', params);
  });
  ...
  ipcMain.handle(channels.PORTFOLIO_MARGINS, async (_, params?: any) => {
    return await pythonBridge.call('get_margins', params);
  });
